...
def _extract_news_item(entry: Dict[str, Any]) -> Dict[str, str] | None:
    ...
    if isinstance(publish_raw, str):
        # Some payloads provide ISO datetime strings.
        try:
            publish_raw = int(datetime.fromisoformat(publish_raw.replace("Z", "+00:00")).timestamp())
        except ValueError:
            publish_raw = None
    ...
    return {
        ...
        "link": str(link or "#"),
        "published": _format_publish_time(publish_raw),
    }
